...
1. [Запускаем Selenium Grid локально](#Запускаем Selenium Grid локально)
2. [Подготовка к запуску Selenium GRID](#Подготовка к запуску Selenium GRID)
3. [Запускаем Хаб и НОДы локально, передавая параметры через командную строку](#Запускаем Хаб и НОДы локально, передавая параметры через командную строку)
4. [Запуск тестов на Гриде](#Запуск тестов на Гриде)
5. [Остановка запущеных НОД и ХАБа](#Остановка запущеных НОД и ХАБа)
6. [Добавляем настройки для нод и хаба с помощью '.json'](#Добавляем настройки для нод и хаба с помощью '.json')
7. [Автоматический запуск ХАБА и НОД](#Автоматический запуск ХАБА и НОД)
8. [Распределённый запуск ХАБА и НОД](#Распределённый запуск ХАБА и НОД)
9. [Запуск Selenium Grid в Docker](#"Запуск_Selenium_Grid_в_Docker")
...
<a name="Запускаем Selenium Grid локально"></a>
***
#### Установка openJDK
...
<a name="Подготовка к запуску Selenium GRID"></a>
...
<a name="Запускаем Хаб и НОДы локально, передавая параметры через командную строку"></a>
...
<a name="Запуск тестов на Гриде"></a>
...
<a name="Остановка запущеных НОД и ХАБа"></a>
...
<a name="Добавляем настройки для нод и хаба с помощью '.json'"></a>
...
<a name="Запуск_Selenium_Grid_в_Docker"></a>
