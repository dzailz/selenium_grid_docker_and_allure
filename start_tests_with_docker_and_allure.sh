...
gnome-terminal -x sh -c "py.test --alluredir=~/stepik_traineeship/allure/ -v -s -m smoke --executor=http://127.0.0.1:4444/wd/hub --domain=https://staging1.int.stepik.org -n2; bash"
sleep 2
